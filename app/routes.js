...
routes.delete(
  ...
  controllers.creditCardController.destroy
);
...
routes.get(
  ...
  controllers.transactionController.showSend
);
routes.get(
  "/account/transaction/received",
  controllers.transactionController.showReceived
);
